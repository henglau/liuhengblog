...
(function($){
	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			// 定义分页导航
			var PagesNavHtml = "<div class=\"Pagination\"><a href=\"javascript:;\" class=\"homePage\" style=\"display:none;\">首页</a><a href=\"javascript:;\" class=\"PagePrev\"><</a></span><div class=\"pagesnum\"></div><a href=\"javascript:;\" class=\"PageNext\">></a><a href=\"javascript:;\" class=\"lastPage\" style=\"display:none;\">尾页</a><cite class=\"FormNum\" style=\"display:none;\">直接到第<input type=\"text\" name=\"PageNum\" id=\"PageNum\">页</cite><a href=\"javascript:;\" style=\"display:none;\" class=\"PageNumOK\">确定</a></div>";
			...
			if($AllMth > $Mth){
					...
					var PagesMthTxt = "<span style=\"display:none;\">共<b>" + $AllMth + "</b>条，共<b>" + PagesMth + "</b>页</span>";
